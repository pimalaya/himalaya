//! # JMAP vacation set
//!
//! The `jmap vacation-response set` command, RFC 8621
//! `VacationResponse/set`.

use anyhow::{Result, bail};
use clap::Parser;
use io_jmap::rfc8621::vacation_response::{
    JMAP_VACATION_RESPONSE_CAPABILITY, set::JmapVacationResponseUpdate,
};
...
impl JmapVacationSetCommand {
    /// Applies the patches to the vacation response.
